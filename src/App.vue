...
import { sesionActiva, usuarioActual } from "./services/auth.js";
...
const autenticado = ref(!!localStorage.getItem("token"));
</script>
...
<template>
  ...
  <div v-else>
    <div class="flex justify-between items-center p-4">
      <span class="text-sm text-base-content/70">{{ usuarioActual }}</span>
      <button class="btn btn-sm btn-ghost" @click="api.logout()">Cerrar sesión</button>
    </div>
    <!-- toda tu app actual -->
